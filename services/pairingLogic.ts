...
// Use combined standard imports as per guidelines
...
export const generateSmartPairings = async (
  ...
  // Initialize ai using exact property object as defined in Gemini guidelines
  ...
  try {
    ...
    // Using trim() on text property before parsing
